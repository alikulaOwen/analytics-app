...
import { getSalesData } from '../../features/analytics/saleSummarySlice';
...
const dispatch = useAppDispatch()
 const { isLoading, error, salesList } = useAppSelector(
    (state) => state.sales
  );
useEffect(()=>{
...
//     <p className='text-[56px] mt-12 ' >{salesList.length}</p>
//           </div>
